...
wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=yourkeygoeshere', NULL, '1.0', true);
  ...
  wp_localize_script('main-university-js', 'universityData', array(
    ...
    wp_enqueue_style('hariweb_main_styles',get_stylesheet_uri());
}
add_action('wp_enqueue_scripts', 'hariweb_files' );

function hariweb_features() {
    add_theme_support( 'title-tag' );
}
add_action( 'after_setup_theme','hariweb_features');
?>
